...
<head>
    ...
    <!-- Include same CSS/JS as user chat -->
  <style>
        body {
        ...
        <div class="col-md-8 mx-auto">
            <div class="card shadow">
                <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                    <a href="{{ route('owner.chats.index') }}" class="btn btn-light btn-sm">
                        <i class="fa fa-arrow-left me-1"></i> Back to Chats
                    </a>
                </div>

                <!-- Same message display area as user chat -->
                ...
                <!-- Same message form as user chat -->
